...
foreach(_src
  ...
  if(EXISTS "${_src}")
    ...
    if(NOT _bad_old_placeholder EQUAL -1)
      message(FATAL_ERROR "Rejected old Search anything placeholder in ${_src}; v1.1.7 uses 2026 Heritage Inc.")
    endif()
    string(TOLOWER "${_text}" _text_lower)
    string(FIND "${_text_lower}" "footer" _bad_footer)
    if(NOT _bad_footer EQUAL -1)
      message(FATAL_ERROR "Rejected persistent footer UI in ${_src}; v1.1.7 keeps branding only in the empty search placeholder.")
    endif()
  endif()
endforeach()
